...
@Component
@Scope("singleton")
public class QueryCouchDBMetadataValue
{
	...
	public Response queryMetadata(@QueryParam("callback") String callback, @QueryParam("type") String type, @QueryParam("field") String field,
			@QueryParam("value") String value)
	{
		...
		try
		{
			getRequest = new HttpGet("http://" + host + ":" + port + "/"
					+ database
					+ "/_design/query_metadata_value/_view/general?key=[%22"
					+ type + "%22,%22" + field + "%22,%22" + value + "%22]&include_docs=true");
